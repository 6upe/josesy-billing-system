...
<html lang="en"> 
<head>
    <title>Billing System - Josesy</title>
...
<header class="app-header fixed-top">	   	            
        ...
        <div id="app-sidepanel" class="app-sidepanel"> 
	        ...
	        <div class="sidepanel-inner d-flex flex-column">
		        ...
		        <div class="app-branding">
		            ...
		            <a class="app-logo" href="/dashboard"><img class="logo-icon me-2" src="{{ asset('assets/images/icon1.png') }}" alt="logo"><span class="logo-text">Josesy</span></a>
			    ...
			    <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
				    <ul class="app-menu list-unstyled accordion" id="menu-accordion">
					    <li class="nav-item">
					        ...
					        <a class="nav-link {{ $data['nav_status'] == 'home' ? 'active' : '' }}" href="/dashboard">
						        <span class="nav-icon">
		  ...
		  <path fill-rule="evenodd" d="M13 2.5V6l-2-2V2.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5z"/>
					    ...
					    <li class="nav-item">
					        ...
					        <a class="nav-link {{ $data['nav_status'] == 'products' ? 'active' : '' }}" href="/dashboard/products">
						        <span class="nav-icon">
						...
						<li class="nav-item">
					        ...
					        <a class="nav-link {{ $data['nav_status'] == 'clients' ? 'active' : '' }}" href="/dashboard/clients">
						        <span class="nav-icon">
						...
						<li class="nav-item">
					        <a class="nav-link {{ $data['nav_status'] == 'quotations' ? 'active' : '' }}" href="/dashboard/quotations">
						        <span class="nav-icon">
						...
						<li class="nav-item">
					        ...
					        <a class="nav-link {{ $data['nav_status'] == 'invoices' ? 'active' : '' }}" href="/dashboard/invoices">
						        <span class="nav-icon">
  ...
  <circle cx="3.5" cy="10.5" r=".5"/>
						...
						<li class="nav-item">
					        <!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
					        <a class="nav-link {{ $data['nav_status'] == 'payments' ? 'active' : '' }}" href="/dashboard/payments">
						        <span class="nav-icon">
			    ...
			    <div class="app-sidepanel-footer">
				    <nav class="app-nav app-nav-footer">
					    <ul class="app-menu footer-menu list-unstyled">
						    ...
						    <li class="nav-item">
								<!--//Bootstrap Icons: https://icons.getbootstrap.com/ -->
								<a class="nav-link {{ $data['nav_status'] == 'help' ? 'active' : '' }}" href="/account/help">
									<span class="nav-icon">

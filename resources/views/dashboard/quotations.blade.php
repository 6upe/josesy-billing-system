                                ...
                                @foreach ($data['quotations'] as $quotation)
                                    <tr>
                                        ...
                                        <td class="cell">
                                            ...
                                            <a href="{{ route('dashboard.quotations.showQuotation', $quotation->id) }}" class="text-secondary">
                                            ...
                                            <a href="#" class="text-warning">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-receipt" viewBox="0 0 16 16">

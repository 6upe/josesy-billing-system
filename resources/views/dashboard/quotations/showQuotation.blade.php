...
<div class="app-content pt-3 p-md-3 p-lg-4">
    <div class="container-xl">
        <h1 class="app-page-title">Preview Quotation</h1>
        <div class="row g-4 settings-section">
            <div class="col-12 col-md-12">
                <div class="app-card app-card-settings shadow-sm p-4">
                    ...
                    <a type="button" class="btn app-btn-success" data-bs-toggle="modal" data-bs-target="#pdfModal">
                        ...
                        <form class="d-none" id="quotationForm" method="POST" action="{{ route('dashboard.quotations.updateQuotation', $data['quotation']->id) }}">
                            @csrf
                            @method('PUT')
